...

{
    ...
    'version': '18.0.0.0.38',
    'depends': ['droggol_theme_common' ,'product_bom_view_website','website_sale','website_sale_comparison'],
    #
    'license': 'OPL-1',
    ...
    'data': [
        ...
        'views/ots_website_kanban_view.xml',
    ...
    'assets': {
        'web.assets_frontend': [
            ...
            'theme_prime/static/src/js/variant_add_to_cart.js',
            'theme_prime/static/src/js/saas_subscribe_inherit.js',
